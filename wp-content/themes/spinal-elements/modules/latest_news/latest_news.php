...
wp_enqueue_style('latest_news_style', get_template_directory_uri() . '/static/css/modules/latest_news/latest_news.css', [], null);

wp_enqueue_script( 'latest_news_js', get_template_directory_uri() . '/static/js/modules/latest_news/latest_news.js', [], null, true );
...
if ( $blogs->have_posts() ) 
{ ?>
    <section class="latest_news <?php if($add_pattern == 1){ echo "add-pattern"; } 
        ...
        <div class="container">
            <div class="row wow fadeInUp">
                ...
                <div class="latest-news-block">
                    <div class="latest-news-row"><?php
                        while ( $blogs->have_posts() )
                        {   
                            $blogs->the_post(); ?>
                            <div class="latest-item-inner wow fadeInDown">
                                <div class="blog-title">
                                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                </div>
                                <div class="blog-content-bottom">
                                    <span class="date-light"><?php echo get_the_date('M d, Y'); ?></span>
                                    <a href="<?php the_permalink(); ?>" class="btn btn-darkred viewbtn">View</a>
                                </div>
                            </div><?php
                        } wp_reset_query(); ?>
                    </div><?php
                    ...
                    if($button)
                    { ?>
                        <div class="text-center btn-morenews"><a href="<?php echo $button['url']; ?>" class="btn btn-darkred morecomapny"><?php echo $button['title']; ?></a></div><?php
                    } ?>
                </div>
        </div>
    </section><?php 
