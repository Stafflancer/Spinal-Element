...
wp_enqueue_script( 'cta_subscribe_js', get_template_directory_uri() . '/static/js/modules/cta_subscribe/cta_subscribe.js', [], null, true );
 ?>
    <section class="cta_subscribe <?php if($add_pattern == 1){ echo "add-pattern"; } 
   ...
   ?>"
        ...
        <div class="container <?php echo "content_width".$content_width; ?>"><?php
                $cta_subscribe_heading = get_sub_field('heading');
                    $cta_subscribe_content = get_sub_field('button');
                    $cta_subscribe_form = get_sub_field('form'); ?>
